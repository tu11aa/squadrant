...
This project is indexed by GitNexus as **claude-cockpit** (477 symbols, 909 relationships, 29 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

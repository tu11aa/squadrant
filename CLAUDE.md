...
This project is indexed by GitNexus as **claude-cockpit** (444 symbols, 830 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

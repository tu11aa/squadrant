...
This project is indexed by GitNexus as **claude-cockpit** (447 symbols, 848 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **claude-cockpit** (492 symbols, 938 relationships, 30 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

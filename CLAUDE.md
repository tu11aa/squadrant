...
This project is indexed by GitNexus as **claude-cockpit** (3614 symbols, 5980 relationships, 88 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

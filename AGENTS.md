...
This project is indexed by GitNexus as **claude-cockpit** (504 symbols, 976 relationships, 34 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

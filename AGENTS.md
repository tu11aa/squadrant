...
This project is indexed by GitNexus as **claude-cockpit** (513 symbols, 987 relationships, 35 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

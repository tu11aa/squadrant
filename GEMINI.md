...
S3660 Investigate excessive node processes (25 mcp-server, ~1.3GB RAM) suspected from oneplan/squadrant (Jun 1 at 8:02 PM)
12224 10:00p 🔵 Node process investigation reveals mcp-server as primary resource consumer
12225 " 🔵 All 25 mcp-server processes are MCP server instances from common parent
12227 10:01p 🔴 Fixed mcp-server MCP server resource leak from codex app-server
12228 " 🔵 mcp-server configured as MCP server in codex with squadrant protocol support
...
12235 " 🔵 Codex Crew Leak Root Cause: Orphaned mcp-server MCP Parented to OpenAI Codex Module

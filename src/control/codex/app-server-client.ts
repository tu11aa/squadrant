...
export class AppServerClient extends EventEmitter {
  ...
  async startThread(params: { cwd: string; model?: string; sandbox?: string; approvalPolicy?: string; developerInstructions?: string; config?: Record<string, unknown> }): Promise<{ threadId: string }> {
